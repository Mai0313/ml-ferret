...
def eval_model_refexp(args):
    # Data
    dataset = RefExpGrounding(img_folder=args.image_path, ann_file=args.data_path, transforms=None)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_path", type=str, default="data/annotations/finetune_refcoco_testA.json"
    )
