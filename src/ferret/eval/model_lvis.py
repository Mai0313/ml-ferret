        ...
        for idx, i in enumerate(obj_list):
            ...
            if args.region_format == "point":
                ...
                if args.no_coor:
                    ...
                    i["question"] = question_prompt.replace(
                        "<location>", "[{}, {}]".format(point_x_textvocab, point_y_textvocab)
                    )
                segment_mask = None
                ...
                if args.no_coor:
                    ...
                    i["question"] = question_prompt.replace(
                        "<location>",
                        "[{}, {}, {}, {}]".format(
                            box_x1_textvocab, box_y1_textvocab, box_x2_textvocab, box_y2_textvocab
                        ),
                    )
            ...
            if args.add_region_feature:
                i["question"] = i["question"].replace(
                    "of the image", f"{DEFAULT_REGION_FEA_TOKEN} of the image"
                )
                generated_mask = generate_mask_for_feature(
                    region_coordinate_raw, raw_w=i["width"], raw_h=i["height"], mask=segment_mask
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--region_format", type=str, default="point", choices=["point", "box", "free_shape"]
    )
