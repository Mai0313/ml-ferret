...
class FlickrGrounding(torchvision.datasets.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        entities = [
            remove_punctuation(caption[t[0][0] : t[0][1]].lower()) for t in postive_item_pos
        ]
...
def eval_model_flickr(args):
    # Data
    dataset = FlickrGrounding(img_folder=args.image_path, ann_file=args.data_path, transforms=None)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image_path", type=str, default="data/flickr30k/flickr30k_images_split/test"
    )
    parser.add_argument(
        "--data_path", type=str, default="data/annotations/final_flickr_separateGT_test.json"
    )
