...
from ferretui.conversation import default_conversation, conv_templates, SeparatorStyle
from ferretui.constants import LOGDIR
from ferretui.utils import build_logger, server_error_msg, violates_moderation, moderation_msg
import hashlib
    ...
    with gr.Blocks(title="LLaVA", theme=gr.themes.Default(), css=block_css) as demo:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=8):
                chatbot = gr.Chatbot(
                    elem_id="chatbot", label="LLaVA Chatbot", height=650, layout="panel"
                )
                with gr.Row():
                    with gr.Column(scale=8):
                        textbox.render()
