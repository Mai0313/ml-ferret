...
def process_anyres_image(
    image, processor, grid_pinpoints, image_process_func: Optional[Callable] = None
):
    """
    ...
    if image_process_func:
        ...
        image_patches = [
            image_process_func(image_patch)["pixel_values"][0] for image_patch in image_patches
        ]
    else:
...
def process_images(
    images, image_processor, model_cfg, image_process_func: Optional[Callable] = None
):
